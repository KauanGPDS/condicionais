...
if(aposentada == true || portadoraDeDoenca == true){
    console.log("Não Paga Imposto")
}else if(aposentada == false && totalDeRendimentos <= 27000 || portadoraDeDoenca == false && totalDeRendimentos <= 27000){
    console.log("Não Paga Imposto")
}else if(aposentada == true && totalDeRendimentos >= 27000 || portadoraDeDoenca == true && totalDeRendimentos >= 27000){
    console.log("Vaza")
}else{
    console.log("Pague o que me deve")
}
